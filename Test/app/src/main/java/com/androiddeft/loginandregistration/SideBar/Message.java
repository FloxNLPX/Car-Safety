...
import com.androiddeft.loginandregistration.ProductsAdapter;
                        ...
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                productList.add(new Product(
                                        product.getString("tixstatus"),
                                        product.getString("membershipid"),
                                        product.getString("regno"),
                                        product.getString("vmodel")
                                ));
                            }
